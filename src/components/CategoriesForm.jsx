        ...
        <>
            <div className="my-10 relative max-w-lg mx-auto border rounded border-indigo-400 p-8 m">
                <div className="flex justify-between ">
                    ...
                    <h2 className="text-base font-semibold leading-6 text-gray-900">Categorize Question</h2>
                ...
                <div className=" border-t grid gap-y-2 border-gray-900/10 mt-2 py-4 row">
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                        <div className="sm:col-span-3">
                            ...
                            <h5 className="text-indigo-600 font-semibold mt-2 text-sm mt-2 leading-6 cursor-pointer ">+ New Item</h5>
                                ...
                                <div className="sm:col-span-3">
                                    ...
                                    <div className="mt-2">
                                        <select
                                            ...
                                            name="country"
                                            autoComplete="country-name"
                                            className="block w-full rounded-md border-0 p-4 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6"
                                        >
                                            <option>Category 1</option>
                                            <option>Category 2</option>
                                            <option>Category 3</option>
